/**
 * The shapes the new-mod command speaks in, read by the server that answers it and by every client
 * that asks. Nothing here is more than JSON, so both sides share the one declaration and a change to
 * a field is a compile error on the side that has not followed it.
 */
