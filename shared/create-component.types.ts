 ...
 * choose between, and the text the command answers with. Read by the server that works the
 * declaration out and by every client that asks for one, so both sides share the one declaration. The
