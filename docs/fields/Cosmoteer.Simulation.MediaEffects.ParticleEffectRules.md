...
Plays a particle system at the effect's position, pairing a shared `Def` that describes the particles with an `EmitterDef` that sets how fast they come out.
