...
One kind of hull such as the terran ship or an asteroid, listing every part and door it can be built from plus all its flight, construction and combat tuning.
