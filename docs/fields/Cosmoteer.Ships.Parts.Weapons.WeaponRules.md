...
Shared setup for weapons, covering fire interval, what may be targeted and whether the player can take direct control. A modder writes `FixedWeapon` or `TurretWeapon`.
