...
export const partGridEditorStrings = (): Record<string, string> => ({
    ...
    'Drag the corner handles to resize. This rect is written from references, so the numbers are written where they are declared.': l10n.t('Drag the corner handles to resize. This rect is written from references, so the numbers are written where they are declared.'),
    ...
    'This location is written from references, so the numbers are written where they are declared.': l10n.t('This location is written from references, so the numbers are written where they are declared.'),
