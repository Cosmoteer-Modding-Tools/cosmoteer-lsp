 ...
 */
class ShowEffectiveGroupAction : AnAction() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        showEffectiveGroup(project, file, editor.caretModel.offset)
    }
}
    ...
    LanguageServerManager.getInstance(project)
        ...
        .thenAccept { markdown ->
            ApplicationManager.getApplication().invokeLater {
                ...
                val report = LightVirtualFile("What The Game Loads.md", markdown)
